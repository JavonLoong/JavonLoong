window.resumeData = {
  person: {
    ...
    positioning: "AI 应用工程 / 工程仿真复刻 / 产品原型 / 视觉表达",
    statement:
      "把 AI 从工具用法，变成可运行、可验证、可交付的工作系统。擅长把模糊任务拆成资料检索、数据清洗、Prompt / Skill / SOP、Agent 分工、工具调用、代码实现、测试验证和 PPT / PDF 交付闭环。"
  },
  links: [
  ...
  aiProjects: [
    ...
    },
    {
      name: "美育图像与 PPT 制作",
      type: "视觉表达",
      tags: ["图像生成", "页面重绘", "contact sheet", "PPT 汇报"],
      points: [
        "基于“美育 / 薪火计划”等材料完成素材筛选、生成图像、页面重绘、contact sheet 核对和 PPT 整理。",
        "重点体现审美判断、版式控制和风格一致性，而不是简单统计生成次数。"
      ]
    },
    {
  ...
  practice: [
    ...
    {
      name: "志愿公益与公众讲解",
      role: "累计二百余小时；大一学年 107 小时",
      period: "2024 - 2025",
      points: [
        "参与高考招生志愿服务（35 小时）、校园日常讲解服务（34 小时）、第 23 届“情系母校”回访母校活动（26 小时）。",
        "参与鸿雁计划训练营、清华大学校园讲解、大型展会现场志愿服务，具备公众讲解、咨询服务、现场协作和活动执行经验。"
      ]
    },
    {
      name: "教学表达与辅导经历",
