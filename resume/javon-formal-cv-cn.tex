...
\section{教育背景}
\cventry{2024.09--2028.07}{本科生}{清华大学，行健书院}{北京}{预计毕业}{理论与应用力学 + 能源与动力工程双学位。}
...
\section{项目经历}
\cventry{RAG / GraphRAG}{动力装备领域 RAG/GraphRAG 智能知识问答系统}{核心开发，FastAPI, Chroma, 混合检索}{}{}{
\begin{itemize}
  \item 面向燃气轮机、风电设备等动力装备资料查阅难、问答无依据的问题，搭建本地化、可溯源的智能知识问答系统。
  \item 负责文档解析/OCR 清洗、智能分块、向量入库、FastAPI 检索接口、GraphRAG 图谱能力、自动化评测与 Web 控制台落地。
  \item 围绕 6098 页资料沉淀 593 条 chunk，支持可演示、可评测、可追溯的专业问答闭环。
...
\begin{itemize}
  ...
  \item 优化活动议程、物资清单、现场分工与会员共创机制，推动主题烹饪和交流活动稳定落地。
\end{itemize}}

\cventry{2026 寒假}{支队长 / “鹿城小齿轮计划”首批学员}{E起向未来“九原青禾”电子系赴包头支教调研支队}{}{}{
\begin{itemize}
  \item 围绕包头稀土深加工、国防制造、城市生态与人才留存开展调研，形成青年视角的产业与城市发展建议。
  \item 在包头九十五中（包钢一中）开展数字逻辑、人工智能、计算机、角动量、熵等科普支教，将本地产业特色转化为工程科技启蒙素材。
  \item 提炼“实践--实习--就业”衔接、中试基地建设、生产性服务业平台和稀土标准话语权等政策建议。
\end{itemize}}
